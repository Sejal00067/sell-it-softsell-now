  ...
  return (
    <section className="relative py-20 md:py-28 overflow-hidden">
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden">
        ...
        <div className="absolute -top-40 -right-40 w-80 h-80 bg-softsell-100 rounded-full opacity-70 dark:bg-softsell-900 dark:opacity-20"></div>
        <div className="absolute -bottom-20 -left-20 w-60 h-60 bg-amber-100 rounded-full opacity-70 dark:bg-amber-900 dark:opacity-20"></div>
      </div>
      ...
      <div className="container-custom flex flex-col lg:flex-row items-center">
        ...
        <div className="w-full lg:w-1/2 text-center lg:text-left mb-10 lg:mb-0 animate-fade-in">
          ...
          <p className="text-xl mb-8 text-gray-600 dark:text-gray-300 max-w-2xl mx-auto lg:mx-0">
            ...
            <div className="bg-white dark:bg-gray-800 shadow-xl rounded-2xl p-6 border border-gray-200 dark:border-gray-700">
              <div className="flex justify-between mb-6 items-center">
                <div className="bg-softsell-100 dark:bg-softsell-900/40 rounded-md p-3">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-softsell-600">
              ...
              <button className="mt-6 w-full py-3 px-4 bg-softsell-600 hover:bg-softsell-700 text-white rounded-lg transition-colors">
                Complete Valuation
              </button>
            </div>
            
            <div className="absolute -bottom-4 -right-4 w-24 h-24 bg-amber-500 rounded-full opacity-20 z-[-1]"></div>
            <div className="absolute -top-4 -left-4 w-16 h-16 bg-softsell-500 rounded-full opacity-20 z-[-1]"></div>
          </div>
        </div>
      </div>
    </section>
