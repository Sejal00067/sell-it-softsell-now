        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-6 max-w-md">
              SoftSell is the leading marketplace for buying and selling software licenses. 
              We connect sellers with verified buyers to ensure the best rates and secure transactions.
            </p>
